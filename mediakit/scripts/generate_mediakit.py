...
def main():
    ...
    parser.add_argument(
        "--format", choices=["html", "pdf", "all"], default="html", help="Output format (default: html)"
    )
    parser.add_argument(
        "--template", default=None, help="Template name to use (default: default.html for HTML, pdf.html for PDF)"
    )
