...
export function initCookieConsent() {
    ...
    const CONSENT_DATE_KEY = 'linkbio_consent_date';
    ...
    banner.innerHTML = `
        <div class="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
            <div class="text-sm text-gray-300">
                ...
                <p>This site uses cookies for analytics and to improve your experience. You can accept or decline optional cookies. <a href="/privacy" target="_blank" class="underline hover:opacity-75">Privacy Policy</a></p>
            </div>
            <div class="flex gap-3 w-full md:w-auto flex-shrink-0">
